...
*Custom Claude Code skills available: `/create-project-roadmap`, `/expand-project-roadmap`, `/review-project-roadmap`*

Create project roadmap (see [Project Roadmap Guide](/docs/guides/project-roadmap.md) for details and instructions)

### Step 3 - Create Gitea Project Boards
Create project boards for each Phase in the Gitea repository.

### Step 4 - Scope Tasks
*Custom Claude Code skills available: `/create-issues`, `/create-sub-phase`*
