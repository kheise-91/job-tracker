...
| [Sidebar](Sidebar.md) | Dark-themed vertical navigation panel with logo, title, nav links, and Filters section with toggle control. Fully controlled by parent. Overlays content at tablet sizes (< 1024px) instead of pushing layout; fills full viewport width on mobile (< 768px) when expanded. |
